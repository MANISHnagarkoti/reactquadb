      ...
      <div className="detail-wrapper">
        <div className="img-wrapper">
          {data?.image?.original ? (
            ...
            <img src="https://www.hospitto.com/media/nopicture.gif" alt="" />
          )}
        </div>
        ...
        <div className="info-wrapper">
          ...
          <div className="extrainfo">
            <div className="info-one">
              <div className="info-one-one">
                {" "}
                <div>Staus:</div> <div className="info">{data.status}</div>{" "}
              </div>

              <div className="info-one-one">
                {" "}
                <div>Premiered:</div>{" "}
                <div className="info">{data.premiered}</div>{" "}
              </div>

              <div className="info-one-one">
                {" "}
                <div>Language:</div> <div className="info">{data.language}</div>{" "}
              </div>
            </div>

            <div className="info-two">
              <div className="info-two-one">
                {" "}
                <div>Rating:</div>{" "}
                <div className="info">{data.rating.average}</div>{" "}
              </div>
            </div>
          </div>
        </div>
